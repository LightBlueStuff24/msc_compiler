...
class Advancement {
  ...
  public static async init() {
    ...
    } else this.Data.icon = "textures/ui/advancement/default";

    if (this.Name) {
      if (typeof this.Name != "string") { Log.error(Emsg.typeError(this.Name, "string")); return; };
    ...
    if (this.Description) {
      if (typeof this.Description != "string") { Log.error(Emsg.typeError(this.Description, "string")); return; }
    ...
    if (this.Rewards) {
      if (!isType(this.Rewards, 'object')) { Log.error(Emsg.typeError(this.Rewards, 'object')); return; }
