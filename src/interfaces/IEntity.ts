...
import { EntityType, PropertyType } from "../enums/EntityValues";
...
export class IEntityComponents {
    ...
    public static ComponentGroups: ObjectStruct<string, IEntityComponents | IEntityComponents[]>;
    public static IsSpawnable: bool;
    public static IsSummonable: bool;
    public static RuntimeId: EntityType;
