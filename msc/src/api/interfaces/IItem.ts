...
import type { ObjectStruct, bool, int } from "../../utils/Types";
...
interface IDestroySpeedEntry {
  Block: string;
  Speed: int;
}
interface IDigger {
  UseEfficiency: boolean;
  DestroySpeed: IDestroySpeedEntry[];
}
...
export class IItemComponents {
  ...
  public static OnUse(player: Player, itemStack: ItemStack): void {}

  public static OnUseOnBlock(
    player: Player,
    itemStack: ItemStack,
    block: Block
  ): void {}
